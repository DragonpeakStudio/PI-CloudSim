...
int main(int, char**) 
{
    ...
    auto collision = voxelizeHeightMap(heightMap.get(), std::make_pair(glm::vec3(-512,-512,0), glm::vec3(512,512,256)), 4.f);
    ...
    auto cloudSystem = CloudSystem::create<CloudVolumeRenderer, CloudFluidSimulator>(std::make_pair(glm::vec3(-512,-512,0), glm::vec3(512,512,256)), lighting, 4.f);
