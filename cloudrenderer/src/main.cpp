...
int main(int, char**) 
{
    ...
    auto terrain = std::make_shared<Terrain>(std::make_unique<eng::rndr::Texture2d>("../resources/terrain/export/height.tiff", eng::rndr::TextureInfo{GL_REPEAT, GL_REPEAT, GL_LINEAR, GL_LINEAR, GL_RED, 1, GL_R16F, GL_FLOAT}),
